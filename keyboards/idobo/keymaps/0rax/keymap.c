...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BL] = LAYOUT_ortho_5x15(
    K_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_GRV,  KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  ...
  // |--------------------------------------------------------------------------------------------------------------------------------------|
  // | LSHIFT |        | CUT    | COPY   | PASTE  |        | RGBH↑  | RGBB↑  | RGBS↑  |        |        |        |        |        | RSHIFT |
  // |--------------------------------------------------------------------------------------------------------------------------------------|
  // | LCTRL  | LGUI   | LALT   | FN     | SPACE  | SPACE  | RGBH↓  | RGBB↓  | RGBS↓  | SPACE  | SPACE  | FN     | RALT   | RGUI   | RCTRL  |
  // '--------------------------------------------------------------------------------------------------------------------------------------'
