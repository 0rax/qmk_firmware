...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [BL_PSLS] = ACTION_TAP_DANCE_DUAL_ROLE(KC_PSLS, _BL),
  [FL_PAST] = ACTION_TAP_DANCE_DUAL_ROLE(KC_PAST, _FL),
  [AL_PMNS] = ACTION_TAP_DANCE_DUAL_ROLE(KC_PMNS, _AL),
  [ML_PPLS] = ACTION_TAP_DANCE_DUAL_ROLE(KC_PPLS, _ML),
};
